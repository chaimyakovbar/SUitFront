...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React11.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React11.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React11.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React11.useState(noSsr || !isMultiSchemes);
  React11.useEffect(() => {
    setIsClient(true);
  }, []);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React12.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React12.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React12.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FIAXDG6A.js.map
