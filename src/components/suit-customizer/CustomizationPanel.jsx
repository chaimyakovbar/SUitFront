        ...
        <AnimatePresence mode="wait">
          ...
          >
            {CurrentStepComponent && (
              <CurrentStepComponent isPantsMode={isPantsMode} isMobile={isMobile} />
            )}
          </motion.div>
        </AnimatePresence>
      </Box>
  ...
  return (
    ...
    >
      <Paper
        elevation={0}
        sx={{
          background: 'linear-gradient(135deg, rgba(20, 20, 20, 0.7) 0%, rgba(30, 30, 30, 0.5) 100%)',
      ...
      >
        ...
        <Box
          sx={{
            ...
            background: 'linear-gradient(135deg, rgba(192, 211, 202, 0.05) 0%, transparent 100%)',
            flexShrink: 0
          }}
        >
          <Typography
