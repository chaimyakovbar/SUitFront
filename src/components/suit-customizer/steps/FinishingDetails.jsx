...
import { Box, Typography, Grid, Drawer, IconButton, Divider } from '@mui/material';
...
const FinishingDetails = ({ isPantsMode, isMobile }) => {
  ...
  const [selectedSleeveButtons, setSelectedSleeveButtons] = useAtom(selectedSleeveButtonsAtom);
  ...
  const renderSleeveButtonsContent = () => {
    const sleeveOptions = [
      { value: 'none', label: 'No Buttons', description: 'Clean, minimal look' },
      { value: 'tree', label: '3 Buttons', description: 'Classic three-button style' },
      { value: 'four', label: '4 Buttons', description: 'Modern four-button design' },
      { value: 'five', label: '5 Buttons', description: 'Premium five-button finish' }
    ];
  ...
  const renderTopCollarContent = () => {
    const colorOptions = [
      { name: 'black', color: '#222', label: 'Black', description: 'Classic black collar' },
      { name: 'greyLight', color: '#d3d3d3', label: 'Light Grey', description: 'Subtle light grey' },
      { name: 'grey', color: '#888', label: 'Dark Grey', description: 'Sophisticated dark grey' },
      { name: 'bhez', color: '#e5d1b8', label: 'Beige', description: 'Warm beige tone' },
      { name: 'red', color: '#c00', label: 'Red', description: 'Bold red accent' },
      { name: 'blueLight', color: '#8ecae6', label: 'Light Blue', description: 'Fresh light blue' },
      { name: 'white', color: '#fff', label: 'White', description: 'Clean white finish' }
    ];
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <Box
                    ...
                    sx={{
                      ...
                      border: selectedTopCollarColor === item.name
                        ? '3px solid rgba(192, 211, 202, 0.8)' : '2px solid rgba(192, 211, 202, 0.2)',
                      borderRadius: '50%',
                      cursor: 'pointer',
                      mb: 1,
                      boxShadow: selectedTopCollarColor === item.name
                        ? '0 6px 20px rgba(192, 211, 202, 0.4)' : '0 2px 8px rgba(0, 0, 0, 0.2)',
                      transition: 'all 0.3s ease',
                      backdropFilter: 'blur(10px)',
                      '&:hover': {
                        transform: 'scale(1.1)',
              ...
              <Box
                ...
                sx={{
                  ...
                  '&::before': {
                    ...
                    right: 0,
                    bottom: 0,
                    background: 'linear-gradient(135deg, rgba(192, 211, 202, 0.05) 0%, transparent 50%)',
                    opacity: 0,
                ...
                <Box
                  sx={{
                    ...
                    '&::after': {
                      ...
                      width: '100%',
                      height: '100%',
                      background: 'radial-gradient(circle, rgba(192, 211, 202, 0.1) 0%, transparent 70%)',
                      borderRadius: '50%',
                      opacity: 0,
                      transition: 'opacity 0.3s ease'
                    }
                ...
                >
                  <img
                    ...
                    style={{
                      ...
                      height: '100%',
                      objectFit: 'contain',
                      filter: 'brightness(1.3) contrast(0.9) invert(1) sepia(0) saturate(0) hue-rotate(0deg)',
                      opacity: 0.95,
                      transition: 'all 0.3s ease'
                    }}
                  />
          ...
          >
            <Box sx={{ 
              ...
              <Box>
                ...
                >
                  {selectedCategory === 'sleeveButtons' && 'Select the number of buttons for your sleeve cuffs'}
                  {selectedCategory === 'topCollar' && 'Select the color for your top collar accent'}
                  {selectedCategory === 'imagesInsideUp' && 'Choose your inner lining style'}
                  {selectedCategory === 'imageButton' && 'Select your button style'}
                  {selectedCategory === 'imagesHoles' && 'Choose your button hole color'}
                </Typography>
              </Box>
              <IconButton 
