...
const popularItems = [
  {
    ...
    description:
      "Timeless elegance for formal occasions. Crafted with premium Italian wool for exceptional comfort.",
    price: "$599",
    link: "/collection/1",
  },
  {
    ...
    description:
      "Professional style for the modern executive. Tailored fit with subtle details for a refined look.",
    price: "$649",
    link: "/collection/2",
  },
  {
    ...
    title: "Gray Slim Fit",
    description:
      "Contemporary design for a sophisticated appearance. Perfect for both formal and semi-formal events.",
    price: "$579",
    link: "/collection/3",
  },
];
